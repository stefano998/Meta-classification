function [obs_errors, outs_positions] = gera_smc(qtd_0out,MVC, dp, m, qtd_itr, qtt_outs_min, qtt_outs_max, min_err, max_err)

outs_positions = [];
obs_errors = [];
er = (mvnrnd(zeros(m,1),MVC,qtd_0out));
outs_positions = zeros (qtd_0out, m);
obs_errors = er;
